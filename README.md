...
| Поле | Значение |
|---|---|
| Источник | вкладка «IP-адрес», IP вашего сервера, порт 80 — домен источника не нужен |
...
Свой домен для клиентов не нужен: технический домен `xxxxx.cdn.twcstorage.ru`
создаётся автоматически, сертификат на нём уже валидный — его можно отдать клиентам как есть и в установщике
