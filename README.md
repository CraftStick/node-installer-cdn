...
## 🧩 Четыре сценария развёртывания (`--mode`)
...
| **4** | Только CDN-origin (`--xport` / `--path`) | накинуть CDN перед готовой нодой |

Нужна ещё одна локация к работающей панели — режим **3**: он ставит и ноду, и
фронт за один проход. Режим **4** нужен, когда нода уже поднята и ей не хватает
только CDN-origin.
...
--panel           1 = Remnawave 3.x, 2 = 3x-ui   (режимы 1 и 2)
