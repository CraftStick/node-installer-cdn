...
Пока вверху висит **«Применяются настройки»**, ресурс раскатывается по узлам и
ответы могут скакать — это нормально.
...
| Соединение не поднимается | в CDN-ресурсе выключите кеширование и сжатие, а параметры запроса **не** игнорируйте: в них едут параметры сессии |
