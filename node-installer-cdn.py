...
def print_cdn_instructions(provider, origin, client_domain, my_ip, path):
    ...
    if provider == "yandex":
        ...
        say("""  ШАГ 1 · Сертификат   console.yandex.cloud -> Certificate Manager
       Имя                      %s
       Домены                   %s
       Тип проверки             DNS
  ...
  ШАГ 2 · Ресурс   console.yandex.cloud -> Cloud CDN -> Создать ресурс
  ...
  ШАГ 3 · DNS   страница ресурса, блок "Настройки DNS", строка CNAME
       Type                     CNAME
       Name                     %s
...
""" % (cert, client_domain, client_domain,
       origin, origin, origin, client_domain, cert, client_domain))
